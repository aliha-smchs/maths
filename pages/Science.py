...
from pages import Scienceall


# Set page Title
def show():
    html_header = f"""<h1 style="text-align: center; color: royalblue">PROGRESS ANAYLSIS Science (2023 JUNE - 2024 JUNE).</h1></br>"""
    # You can add more Streamlit elements below
    st.markdown(html_header, unsafe_allow_html=True)

    # Load data files
    file_2023 = "data/Science2023.csv"
    file_2024 = "data/Science2024.csv"
    ...
    grade_boundaries_2024 = {
        ...
        'Year 7': {
            'Science': {'A*': 85, 'A': 75, 'B': 65, 'C': 50, 'D': 45, 'E': 40, 'U': 0},
    ...
    comparison_data['Comparison'] = comparison_data.apply(
        ...
        axis=1)
    st.subheader("Student's Progress (June 2023 - June 2024) in Science")
    Scienceall.alldata()
    # Display data
    ...
    st.subheader(f"Grades Comparison for (2023 June and 2024 June in Science {year_group}")
