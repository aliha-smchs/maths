...
# Load data files
file_2023 = "Maths2023.csv"
file_2024 = "Maths2024.csv"
...
data_2023_filtered['Grade'] = convert_to_grades(data_2023_filtered[subject], grade_boundaries_2023[year_group][subject])
data_2024_filtered['Grade'] = convert_to_grades(data_2024_filtered[subject], boundaries_2024)

# Merge data for comparison
comparison_data = pd.merge(data_2023_filtered, data_2024_filtered, on=['Student', 'Year'], suffixes=('_2023', '_2024'))
...
comparison_data['Comparison'] = comparison_data.apply(lambda row: compare_grades(row['Grade_2023'], row['Grade_2024']),
                                                      axis=1)
...
# Display results
st.subheader("Student's Progress (June 2023 - June 2024) in Mathematics ")
